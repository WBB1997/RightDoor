...
public class RightDoorCommand {
    ...
    public static final int DistanceForNextStation = 65;  //到站 或者 启动
...
//    public static final int StartingSitedepartureRemind = 3; //起始站出发提醒
//    public static final int DistanceForNextStation = 4; //距离下一个站点的距离
